...
import com.mysampleapp.demo.poolit.*;
...
public class UserSettings {
    ...
    // default color
    private static int DEFAULT_TITLE_TEXT_COLOR = 0xFFF2EBCF; // beige
    private static int DEFAULT_TITLE_BAR_COLOR = 0xFF8EB848; // green
